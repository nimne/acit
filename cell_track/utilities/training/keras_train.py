...
Modified by Nick Negretti for use in the 'ACIT' project.

The default command line options have been updated to reflect the parameters
used to train the model. In addition, the script has been reduced to remove
options that are not used in this context.

The full, original training script can be found at the keras-retinanet github:
...
def parse_args(args):
    ...
    parser.add_argument('--epochs',           help='Number of epochs to train.', type=int, default=75)
